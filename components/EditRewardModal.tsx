    ...
    >
      ...
      >
        <div className="flex justify-between items-center p-6 border-b border-slate-200 dark:border-slate-700">
            <h2 id="edit-reward-modal-title" className="text-xl font-extrabold text-slate-800 dark:text-white">Editar Recompensa</h2>
        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="edit-reward-name" className="block text-sm font-bold text-slate-600 dark:text-slate-300 mb-1">
            ...
            <div>
              <label htmlFor="edit-reward-cost" className="block text-sm font-bold text-slate-600 dark:text-slate-300 mb-1">
                Custo em moedas
              </label>
              <input
                id="edit-reward-cost"
