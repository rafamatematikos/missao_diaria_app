...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStart }) => {
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-lg bg-white dark:bg-slate-800 p-8 sm:p-10 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 animate-pop-in text-center">
        ...
        <ul className="text-left space-y-3 mt-8 text-slate-700 dark:text-slate-200">
